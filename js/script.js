...
function createMobileMenu() {
    ...
    // Create mobile menu button with hamburger and close icons
    ...
    function toggleMenu() {
        ...
        if (isOpen) {
            ...
            const burgerIcon = mobileBtn.querySelector('.icon-burger');
            const closeIcon = mobileBtn.querySelector('.icon-close');
